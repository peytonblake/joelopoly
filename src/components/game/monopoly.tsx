    ...
    if (gameState == "start") {
        ...
        if (ai) {
            display = (
                <>
                    <MessageText>{name} landed on {squareName(square)}</MessageText>
                    <MessageText>This square is unowned</MessageText>
                    <MessageText>{name} will buy it for ${square.price}</MessageText>
                    {CardGetter(square.name)}
            ...
            display = (
                <>
                    <MessageText>{name} landed on {squareName(square)}</MessageText>
                    <MessageText>This square is unowned</MessageText>
                    <MessageText>{name} can buy it for ${square.price}</MessageText>
                    {CardGetter(square.name)}
                    <ButtonWrapper><Button to='/game' onClick={buttonWrapper(() => {
                        monopoly.buy();
                        monopoly.state="boughtSquare"
